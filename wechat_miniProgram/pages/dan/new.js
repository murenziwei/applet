...
Page({
  ...
  onLoad: function () {
    ...
    wx.request({
      url: util.api() + 'index.php?s=/Apiindex/load_index_pintuan/orderby/new/is_index_show/0',
  ...
  loadMore: function () {
    ...
    if (!that.data.hasRefesh) {
      ...
      wx.request({
        url: util.api() + 'index.php?s=/Apiindex/load_index_pintuan/orderby/new/is_index_show/1',
        data: {
